...
public class AdapterTeste extends ArrayAdapter {
    ...
    public AdapterTeste (Context context, int layoutId, ArrayList<Subcat> list) {
    ...
    public View getView (int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.card_teste, null);
